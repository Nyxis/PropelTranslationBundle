 ...
 */
class TransUnitTranslationsTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'vendor.quentincerny.propel-translation-bundle.Propel.TranslationBundle.Model.map.TransUnitTranslationsTableMap';
	...
	public function initialize()
	{
		...
		$this->setPhpName('TransUnitTranslations');
		$this->setClassname('Propel\\TranslationBundle\\Model\\TransUnitTranslations');
	...
	public function buildRelations()
	{
		...
		$this->addRelation('TransUnit', 'Propel\\TranslationBundle\\Model\\TransUnit', RelationMap::MANY_TO_ONE, array('key_id' => 'id', ), null, null);
	} // buildRelations()
