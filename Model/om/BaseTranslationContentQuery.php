...
abstract class BaseTranslationContentQuery extends ModelCriteria
{
     ...
     * @param TranslationContentQuery|Criteria $criteria   Optional Criteria to build the query from
     *
     ...
     *
     * @return TranslationContent|TranslationContent[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param PropelPDO $con  an optional connection object
     *
     * @return PropelObjectCollection|TranslationContent[]|mixed the list of results, formatted by the current formatter
     */
     ...
     *
     * @param TranslationFile|PropelObjectCollection $translationFile The related object(s) to use as filter
     * @param string                                 $comparison      Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return TranslationContentQuery The current query, for fluid interface
    ...
    public function filterByTranslationFile($translationFile, $comparison = null)
    {
        ...
        } elseif ($translationFile instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
     ...
     *
     * @param TranslationKey|PropelObjectCollection $translationKey The related object(s) to use as filter
     * @param string                                $comparison     Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return TranslationContentQuery The current query, for fluid interface
     * @throws PropelException         - if the provided filter is invalid.
    ...
    public function filterByTranslationKey($translationKey, $comparison = null)
    {
        ...
        } elseif ($translationKey instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
