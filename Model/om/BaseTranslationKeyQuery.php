...
/**
 * Base class that represents a query for the 'translation_key' table.
 *
 * 
 *
...
abstract class BaseTranslationKeyQuery extends ModelCriteria
{
	 ...
	 *
	 * @return    TranslationKey|array|mixed the result, formatted by the current formatter
	 */
