...
abstract class BaseTranslationFileQuery extends ModelCriteria
{
     ...
     * @param TranslationFileQuery|Criteria $criteria   Optional Criteria to build the query from
     *
     ...
     *
     * @return TranslationFile|TranslationFile[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param PropelPDO $con  an optional connection object
     *
     * @return PropelObjectCollection|TranslationFile[]|mixed the list of results, formatted by the current formatter
     */
